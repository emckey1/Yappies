...
namespace YappiesTesting.Data.Migrations
{
    ...
    [Migration("20190331025810_AddedMessagesThatWork")]
    partial class AddedMessagesThatWork
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YappiesTesting.Models.Message", b =>
                {
                    ...
                    b.Property<int?>("ConversationParentID");

                    b.Property<int?>("ConversationProgramSupervisorID");
                    ...
                    b.HasIndex("ConversationParentID", "ConversationProgramSupervisorID");
            ...
            modelBuilder.Entity("YappiesTesting.Models.Message", b =>
                {
                    b.HasOne("YappiesTesting.Models.Conversation", "Conversation")
                        .WithMany("Messages")
                        .HasForeignKey("ConversationParentID", "ConversationProgramSupervisorID");
                });
